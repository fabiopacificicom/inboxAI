<div>
    ...
    <div class="mb-3">
        ...
        <select name="model" id="model" wire:model.blur="selectedModel"
    ...
    <div class="mb-3">
        ...
        <textarea class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-200"
            wire:model.live.delay3s="assistantSystem" name="assistantSystem" id="assistantSystem" cols="30" rows="10">{{ $assistantSystem }}</textarea>
