<div>
    ...
    <div class="mb-4 flex items-end justify-end p-4">
        ...
        <button class="flex items-center gap-2 p-3 text-gray-600 hover:text-gray-950 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50" popovertarget="settings" popoveraction="show">
            {{ __('AI') }}
