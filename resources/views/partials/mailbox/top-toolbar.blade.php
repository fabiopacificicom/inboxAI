<header id="top_toolbar" class="flex justify-between py-4 px-2">
    ...
    <div class="flex gap-1 items-center">
        ...
        <button title="Put all messages into the trash" type="button" wire:click="deleteMessages(false)"
            class="bg-gray-100 hover:bg-gray-300 dark:bg-slate-900 dark:hover:bg-slate-700 p-2 rounded-lg m-1">
            <span class="hidden sm:text-xs md:text-sm">
                Trash All
            </span>
    ...
    <div class="filters flex gap-1 items-center">
        ...
        {{-- Limit results --}}
        <div id="limit">
            <label for="limit" class="sr-only block">
                Limit results to:
            </label>
            <input type="number" name="limit" id="limit" min="1" max="50"
                wire:model.blur="limit"
                class="w-auto min-w-10 p-2 border dark:bg-slate-900 dark:border-slate-950 dark:text-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-200"
        ...
        <div class="period">
            ...
            <select id="period" wire:model.live="filter"
                class="w-auto min-w-20 p-2 border border-gray-300 dark:bg-slate-900 dark:text-white dark:border-slate-950 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-200">
